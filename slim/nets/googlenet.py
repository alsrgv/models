...
def googlenet_base(inputs,
                      ...
                      scope='GoogleNet'):
  """Defines the GoogleNet base architecture, mirrored from MXNET version.
...
def googlenet(inputs,
                 ...
                 reuse=None,
                 scope='GoogleNet'):
  """Defines the GoogleNet architecture.
  ...
  with tf.variable_scope(scope, 'GoogleNet', [inputs, num_classes],
                         reuse=reuse) as scope:
    with slim.arg_scope([slim.dropout], is_training=is_training):
      net, end_points = googlenet_base(inputs, scope=scope)
...
googlenet.default_image_size = 224

googlenet_arg_scope = inception_utils.inception_arg_scope
